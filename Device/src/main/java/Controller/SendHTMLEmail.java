...
public class SendHTMLEmail {
    ...
    public static void main(String[] args) {
        ...
        final String username = "valverde.alfaro.jimmy@gmail.com";//
        final String password = "odioyamor";
        try {
            ...
            msg.setRecipients(Message.RecipientType.TO,
                    InternetAddress.parse("susanacorrales03@gmail.com"));
            msg.setSubject("Hello");
            msg.setContent("<div style=\"" +
...
"\">" +
"	<h1 style=\"width:100%;\" align=\"center\" >Hola Susana</h1>" +
"	<br>" +
...
"	<p  style=\"font-size:18px ;text-align: justify;\">El dispositivo que solicitaste esta disponible para ti cuentas " +
"	con 5 minutos para tomarlo de lo contrario pasara al siguiente en la lista has click" +
"	<a href=\"http://localhost:8383/AvanticaDeviceFarm/index.html\" target=\"_blank\">aqui</a> para acceder a nuestra pagina web</p>" +
"<br><br><br>" +
"	<table>" +
"		<tr>" +
